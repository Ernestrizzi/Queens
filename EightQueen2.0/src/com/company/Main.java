...
public class Main {
    ...
    static int[][][] memory = new int[size][size][100000]; //Memory of all the possible chess layouts !!Change the size of the Memory if you want the size of the chess board being greater than 13
